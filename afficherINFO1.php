...
<main role="main">
        <div class="jumbotron">
            <div class="container">
              <h1 class="display-4">Liste des groupes 1ère année Informatique</h1>
...
<script>
	...
	function myFunction(response){
		...
		var arr=obj.groupes;
		var i;
		var out='<table class="table table-striped table-hover"><tr> <th>Groupes</th></tr>';
